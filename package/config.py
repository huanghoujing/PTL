...
cfg.model.attr_em_dim = 128  #
cfg.model.use_attr = False  #
cfg.model.attr_format = 'peta'  # ['peta', 'rap']
...
cfg.dataset.ps_label.h_w = (32, 16)  # final size for calculating loss

cfg.dataset.use_attr_label = False
cfg.dataset.attr_format = 'peta'  # Pseudo attr labels for ReID datasets originate from PETA or RAP.
cfg.dataset.pseudo_attr_soft_or_hard = 'soft'
cfg.dataset.peta_sub_dirs = ['3DPeS', 'CAVIAR4REID', 'CUHK', 'GRID', 'MIT', 'PRID', 'SARC3D', 'TownCentre', 'VIPeR', 'i-LID']
...
cfg.dataset.cd_train.transform_list = cfg.dataset.train.transform_list
...
cfg.dataset.attr_test = EasyDict()
cfg.dataset.attr_test.name = ''
cfg.dataset.attr_test.split = ''
cfg.dataset.attr_test.transform_list = ['resize']
...
cfg.dataloader.attr_test = cfg.dataloader.test
...
# source-domain attr loss
cfg.src_attr_loss = EasyDict()
cfg.src_attr_loss.name = 'src_attrL'
cfg.src_attr_loss.weight = 0  #
cfg.src_attr_loss.use = cfg.src_attr_loss.weight > 0
cfg.src_attr_loss.soft_or_hard = 'hard'
cfg.src_attr_loss.print_each_loss = False

# cross-domain attr loss
cfg.cd_attr_loss = EasyDict()
cfg.cd_attr_loss.name = 'cd_attrL'
cfg.cd_attr_loss.weight = 0  #
cfg.cd_attr_loss.use = cfg.cd_attr_loss.weight > 0
cfg.cd_attr_loss.soft_or_hard = 'hard'
cfg.cd_attr_loss.print_each_loss = False
...
cfg.optim.epochs = 60  # Not including warmup/pretrain
cfg.optim.epochs_per_val = 10
cfg.optim.epochs_per_save_ckpt = 1
cfg.optim.steps_per_log = 50
cfg.optim.trial_run = False  #
cfg.optim.resume = False
cfg.only_test = False  #
cfg.test_tasks = ['reid']  # ['reid', 'attr']
cfg.load_items = []  # subset of ['model', 'optim', 'lrsch']
cfg.load_ckpt_file = ''  # for cfg.load_items
cfg.simple_init = False